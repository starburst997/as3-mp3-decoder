...
package atemis.MP3lib.decoder {
	...
	// can silently occur.
	internal final class BitReserve
	{
	   /**
	    ...
	    * entry.
	    */
		private static const			BUFSIZE:int = 4096*8;
		
		/**
		 * Mask that can be used to quickly implement the
		 * modulus operation on BUFSIZE.
		 */
		private static const			BUFSIZE_MASK:int = BUFSIZE-1;
		
		private var 					offset:int, totbit:int, buf_byte_idx:int;
		private const		 			buf:Array = new Array(BUFSIZE);
