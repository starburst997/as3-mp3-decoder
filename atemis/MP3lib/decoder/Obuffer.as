...
package atemis.MP3lib.decoder {
	...
	{
	  public static const	OBUFFERSIZE:int = 2 * 1152;	// max. 2 * 1152 samples per frame
	  public static const   MAXCHANNELS:int = 2;        // max. number of channels
	   ...
	   */
		public function appendSamples(channel:int, f:Array):void
		{
		    var s:int;
	   ...
	   */
	  private function clip(sample:Number):int
	  {
